...
const PsiqController = require("./../controller/psiq.controller");

router.get("/", (req, res) => {
  res.status(200).json({ message: "Rota do tipo PSIQUICO!!!" });
});

router.get("/listall", PsiqController.listAll);
